...
class ChannelFinderScrollIT {
  ...
  public static void extractJacocoReport() {
    ...
    ITUtil.extractJacocoReport(
        ...
        ITUtil.JACOCO_TARGET_PREFIX
            + ChannelFinderScrollIT.class.getSimpleName()
  ...
  void handleScrollDataByTestFixture() {
    ...
    try {
      ...
      actual =
          ITUtilScroll.assertQueryChannels("", ITTestFixture.channels_all_properties_tags.length);
      ...
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?~name=ABC:DEF-GHI:JKL:001", 0);
      ...
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?~name=*ABC:DEF-XYZ:JKL:01?", 0);

      actual = ITUtilScroll.assertQueryChannels("?~name=ABC:DEF-???:JKL:003", 2);
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?~name=ABC:DEF-???:JKL:003", 0);
      ...
      actual =
          ITUtilScroll.assertQueryChannels(
      ...
      actual =
          ITUtilScroll.assertContinueChannelsQuery("/" + actual.getId() + "?~size=3&~from=0", 3);
      actual =
          ITUtilScroll.assertContinueChannelsQuery("/" + actual.getId() + "?~size=3&~from=0", 3);
      actual =
          ITUtilScroll.assertContinueChannelsQuery("/" + actual.getId() + "?~size=3&~from=0", 1);
      actual =
          ITUtilScroll.assertContinueChannelsQuery("/" + actual.getId() + "?~size=3&~from=0", 0);

      actual = ITUtilScroll.assertQueryChannels("?~size=3&~from=1", 3);
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?~size=3&~from=1", HttpURLConnection.HTTP_INTERNAL_ERROR, -1);

      actual = ITUtilScroll.assertQueryChannels("?~size=3&~from=2", 3);
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?~size=3&~from=2", HttpURLConnection.HTTP_INTERNAL_ERROR, -1);

      actual = ITUtilScroll.assertQueryChannels("?~size=3&~from=3", 3);
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?~size=3&~from=3", HttpURLConnection.HTTP_INTERNAL_ERROR, -1);

      actual = ITUtilScroll.assertQueryChannels("?~name=*1*&~size=4&~from=2", 4);
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?~name=*1*&~size=4&~from=2",
      ...
      actual =
          ITUtilScroll.assertContinueChannelsQuery("/" + actual.getId() + "?domain=?????r?????", 0);
      ...
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?domain=?ow*&~size=4&~from=2",
              HttpURLConnection.HTTP_INTERNAL_ERROR,
              -1);
      ...
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?domain!=cryo&~size=4", 1);
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?domain!=cryo&~size=4", 0);

      actual = ITUtilScroll.assertQueryChannels("?domain!=cryo&~size=4&~from=0", 4);
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?domain!=cryo&~size=4&~from=0", 1);
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?domain!=cryo&~size=4&~from=0", 0);
      ...
      actual =
          ITUtilScroll.assertContinueChannelsQuery("/" + actual.getId() + "?element=source", 0);

      actual = ITUtilScroll.assertQueryChannels("?element=initial", 2);
      actual =
          ITUtilScroll.assertContinueChannelsQuery("/" + actual.getId() + "?element=initial", 0);
      ...
      actual =
          ITUtilScroll.assertContinueChannelsQuery("/" + actual.getId() + "?element=magnet", 0);
      ...
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?element=*a*&~size=2&~from=4",
              HttpURLConnection.HTTP_INTERNAL_ERROR,
              -1);
      ...
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?element=initial&element=radio&element=supra", 0);

      actual = ITUtilScroll.assertQueryChannels("?element=rad?o&element=asdf?", 2);
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?element=rad?o&element=asdf?", 0);

      actual =
          ITUtilScroll.assertQueryChannels(
              "?element=initial&element=radio&element=supra&~size=4", 4);
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?element=initial&element=radio&element=supra&~size=4", 2);
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?element=initial&element=radio&element=supra&~size=4", 0);

      actual =
          ITUtilScroll.assertQueryChannels(
              "?element=initial&element=radio&element=supra&~size=4&~from=3", 3);
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?element=initial&element=radio&element=supra&~size=4&~from=3",
              HttpURLConnection.HTTP_INTERNAL_ERROR,
              -1);
      ...
      actual =
          ITUtilScroll.assertQueryChannels(
              "?element!=source&element!=initial",
              ITTestFixture.channels_all_properties_tags.length);
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?element!=source&element!=initial", 0);

      actual = ITUtilScroll.assertQueryChannels("?element!=source&element!=initial&~size=6", 6);
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?element!=source&element!=initial&~size=6", 4);
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?element!=source&element!=initial&~size=6", 0);

      actual =
          ITUtilScroll.assertQueryChannels("?element!=source&element!=initial&~size=6&~from=5", 5);
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?element!=source&element!=initial&~size=6&~from=5",
              HttpURLConnection.HTTP_INTERNAL_ERROR,
              -1);
      ...
      actual =
          ITUtilScroll.assertContinueChannelsQuery("/" + actual.getId() + "?type=readwrite", 0);
      ...
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?type!=asdf&~size=100", 0);
      ...
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?type!=asdf&~size=100&~from=0", 0);
      ...
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?cell=block?&~size=5&~from=5",
              HttpURLConnection.HTTP_INTERNAL_ERROR,
              -1);
      ...
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?cell=block1&cell=block2", 0);

      actual = ITUtilScroll.assertQueryChannels("?cell=*1&cell=*2", 4);
      actual =
          ITUtilScroll.assertContinueChannelsQuery("/" + actual.getId() + "?cell=*1&cell=*2", 0);

      actual = ITUtilScroll.assertQueryChannels("?cell=block1&cell=block2&cell=block2&~size=1", 1);
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?cell=block1&cell=block2&cell=block2&~size=1", 1);
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?cell=block1&cell=block2&cell=block2&~size=1", 1);
      actual =
      ...
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?cell=block1&cell=block2&cell=block2&~size=1", 0);

      actual =
          ITUtilScroll.assertQueryChannels(
              "?cell=block1&cell=block2&cell=block2&~size=1&~from=0", 1);
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?cell=block1&cell=block2&cell=block2&~size=1&~from=0", 1);
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?cell=block1&cell=block2&cell=block2&~size=1&~from=0", 1);
      actual =
      ...
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?cell=block1&cell=block2&cell=block2&~size=1&~from=0", 0);
      ...
      actual =
          ITUtilScroll.assertContinueChannelsQuery("/" + actual.getId() + "?~tag=handle_this", 0);

      actual =
          ITUtilScroll.assertQueryChannels(
              "?~tag=noteworthy", ITTestFixture.channels_all_properties_tags.length);
      actual =
          ITUtilScroll.assertContinueChannelsQuery("/" + actual.getId() + "?~tag=noteworthy", 0);
      ...
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?~tag=*i*&~size=4&~from=1",
              HttpURLConnection.HTTP_INTERNAL_ERROR,
              -1);
      ...
      actual =
          ITUtilScroll.assertContinueChannelsQuery("/" + actual.getId() + "?~tag!=not_used", 0);
      ...
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?~tag!=not_used&~size=10", 0);
      ...
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?domain=cryo&element=source&cell=block1", 0);

      actual = ITUtilScroll.assertQueryChannels("?domain=power&type=write&~tag=noteworthy", 2);
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?domain=power&type=write&~tag=noteworthy", 0);
      ...
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?domain=power&type=write&type=????write&~tag=noteworthy", 0);
      ...
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?domain=*r*&type=*write&~tag=archived&~tag=noteworthy", 0);

      actual =
          ITUtilScroll.assertQueryChannels(
              "?domain=*r*&type=*write&~tag=noteworthy&~size=3&~from=2", 3);
      actual =
          ITUtilScroll.assertContinueChannelsQuery(
              "/" + actual.getId() + "?domain=*r*&type=*write&~tag=noteworthy&~size=3&~from=2",
              HttpURLConnection.HTTP_INTERNAL_ERROR,
              -1);
    } catch (Exception e) {
      fail();
