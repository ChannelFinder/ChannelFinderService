...
class ChannelFinderPropertiesIT {
  ...
  public static void extractJacocoReport() {
    ...
    ITUtil.extractJacocoReport(
        ...
        ITUtil.JACOCO_TARGET_PREFIX
            + ChannelFinderPropertiesIT.class.getSimpleName()
  ...
  void handlePropertyRemoveCheck() {
    ...
    try {
      ...
      ITUtilProperties.assertRemoveProperty(
          AuthorizationChoice.NONE, "/p11", HttpURLConnection.HTTP_UNAUTHORIZED);
      ITUtilProperties.assertRemoveProperty(
          AuthorizationChoice.USER, "/p11", HttpURLConnection.HTTP_NOT_FOUND);
      ITUtilProperties.assertRemoveProperty(
          AuthorizationChoice.ADMIN, "/p11", HttpURLConnection.HTTP_NOT_FOUND);
    } catch (Exception e) {
      fail();
    }
  }
  ...
  void handlePropertyCreateUpdateCheckJson() {
    ...
    String json_property_p1_channels_c1 =
        "{\"name\":\"p1\",\"owner\":\"o1\",\"value\":null,\"channels\":["
    ...
    try {
      ...
      ITUtilProperties.assertCreateReplaceProperty(
          AuthorizationChoice.ADMIN, "/p1", json_incomplete1, HttpURLConnection.HTTP_BAD_REQUEST);
      ITUtilProperties.assertCreateReplaceProperty(
          AuthorizationChoice.ADMIN, "/p1", json_incomplete2, HttpURLConnection.HTTP_BAD_REQUEST);
      ITUtilProperties.assertCreateReplaceProperty(
          AuthorizationChoice.ADMIN, "/p1", json_incomplete3, HttpURLConnection.HTTP_BAD_REQUEST);
      ITUtilProperties.assertCreateReplaceProperty(
          AuthorizationChoice.ADMIN, "/p1", json_incomplete4, HttpURLConnection.HTTP_BAD_REQUEST);
      ITUtilProperties.assertCreateReplaceProperty(
          AuthorizationChoice.ADMIN, "/p1", json_incomplete5, HttpURLConnection.HTTP_BAD_REQUEST);
      ITUtilProperties.assertCreateReplaceProperty(
          AuthorizationChoice.ADMIN, "/p1", json_incomplete6, HttpURLConnection.HTTP_BAD_REQUEST);
      ITUtilProperties.assertCreateReplaceProperty(
          AuthorizationChoice.ADMIN, "/p1", json_incomplete7, HttpURLConnection.HTTP_BAD_REQUEST);
      ITUtilProperties.assertCreateReplaceProperty(
          AuthorizationChoice.ADMIN, "/p1", json_incomplete8, HttpURLConnection.HTTP_BAD_REQUEST);
      ITUtilProperties.assertCreateReplaceProperty(
          AuthorizationChoice.ADMIN, "/p1", json_incomplete9, HttpURLConnection.HTTP_BAD_REQUEST);
      ITUtilProperties.assertCreateReplaceProperty(
      ...
      ITUtilProperties.assertCreateReplaceProperty(
          AuthorizationChoice.ADMIN,
          "/p1",
          json_property_p1_channels_c1,
          HttpURLConnection.HTTP_BAD_REQUEST);

      ITUtilProperties.assertAddPropertyMultipleChannels(
          AuthorizationChoice.ADMIN, "/p1", json_incomplete1, HttpURLConnection.HTTP_BAD_REQUEST);
      ITUtilProperties.assertAddPropertyMultipleChannels(
          AuthorizationChoice.ADMIN, "/p1", json_incomplete2, HttpURLConnection.HTTP_BAD_REQUEST);
      ITUtilProperties.assertAddPropertyMultipleChannels(
  ...
  void handlePropertyCreateUpdateCheck() {
    ...
    try {
      ...
      ITUtilProperties.assertCreateReplaceProperty(
          AuthorizationChoice.ADMIN, "/asdf", property_check, HttpURLConnection.HTTP_BAD_REQUEST);
      ITUtilProperties.assertAddPropertyMultipleChannels(
          AuthorizationChoice.ADMIN, "/asdf", property_check, HttpURLConnection.HTTP_BAD_REQUEST);
  ...
  void handleProperty() {
    ...
    try {
      ...
      ITUtilProperties.assertCreateReplaceProperty(
          AuthorizationChoice.ADMIN, "/t1", property_p1_owner_o1);
      ...
      ITUtilProperties.assertRemoveProperty(
          AuthorizationChoice.NONE, "/p1", HttpURLConnection.HTTP_UNAUTHORIZED);
      ITUtilProperties.assertRemoveProperty(
          AuthorizationChoice.USER, "/p1", HttpURLConnection.HTTP_UNAUTHORIZED);
      ITUtilProperties.assertRemoveProperty(
          AuthorizationChoice.ADMIN, "/p1", HttpURLConnection.HTTP_OK);
  ...
  void handleProperty2() {
    ...
    //         list, create property * 2, list, retrieve, retrieve, delete, list, retrieve, delete,
    // list
    ...
    try {
      ...
      ITUtilProperties.assertListProperties(2, property_p1_owner_o1, property_p2_owner_o1);
      ...
      ITUtilProperties.assertListProperties(1, property_p2_owner_o1);
  ...
  void handleProperty5SingleChannel() {
    ...
    Property property_p1_value =
        new Property(property_p1_owner_o1.getName(), property_p1_owner_o1.getOwner(), "asdf");

    Channel channel_c1_properties = new Channel("c1", "o1");
    channel_c1_properties.addProperty(property_p1_value);

    Property property_p1_channels =
        new Property(property_p1_owner_o1.getName(), property_p1_owner_o1.getOwner());
  ...
  void handleProperty6MultipleChannels() {
    ...
    Property property_p1_value1 =
        new Property(property_p1_owner_o1.getName(), property_p1_owner_o1.getOwner(), "qwer");
    Property property_p1_value2 =
        new Property(property_p1_owner_o1.getName(), property_p1_owner_o1.getOwner(), "asdf");
    Property property_p1_value3 =
        new Property(property_p1_owner_o1.getName(), property_p1_owner_o1.getOwner(), "zxcv");
    ...
    Property property_p1_channels =
        new Property(property_p1_owner_o1.getName(), property_p1_owner_o1.getOwner(), null);
    property_p1_channels.getChannels().add(channel_c1_properties);
  ...
  void handlePropertiesCreateUpdateCheck() {
    ...
    try {
      ...
      ITUtilProperties.assertAddMultipleProperties(
          "", json_multiple, HttpURLConnection.HTTP_BAD_REQUEST);
      ...
      ITUtilProperties.assertAddMultipleProperties(
          "", json_multiple, HttpURLConnection.HTTP_INTERNAL_ERROR);
