 ...
 *
 * <p>Class is tightly coupled to ChannelFinder and Elasticsearch, and requires those to be up and
 * running. Intended usage is by docker integration tests for ChannelFinder and Elasticsearch.
 *
...
public class ITTestFixture {
  ...
  private static void createProperties() {
    Property[] properties_4 =
        new Property[] {property_domain, property_element, property_type, property_cell};
    ...
    try {
      ...
      ITUtilProperties.assertListProperties(
          4, property_cell, property_domain, property_element, property_type);
    } catch (Exception e) {
      fail();
    }
  }
  ...
  private static void createTags() {
    Tag[] tags_4 = new Tag[] {tag_archived, tag_handle_this, tag_noteworthy, tag_not_used};
    ...
    try {
      ...
      ITUtilTags.assertListTags(4, tag_archived, tag_handle_this, tag_not_used, tag_noteworthy);
    } catch (Exception e) {
      fail();
    }
  }
  ...
  private static void setupAddPropertiesToChannels() {
    ...
    try {
      ...
      Property property_domain_cryo =
          new Property(property_domain.getName(), property_domain.getOwner(), "cryo");
      Property property_domain_power =
          new Property(property_domain.getName(), property_domain.getOwner(), "power");
      ...
      ITUtilProperties.assertRetrieveProperty(
          "/domain?withChannels=true", property_domain_channels);
      ITUtilProperties.assertRetrieveProperty("/domain?withChannels=false", property_domain);
      ...
      Property property_element_source =
          new Property(property_element.getName(), property_element.getOwner(), "source");
      Property property_element_initial =
          new Property(property_element.getName(), property_element.getOwner(), "initial");
      Property property_element_radio =
          new Property(property_element.getName(), property_element.getOwner(), "radio");
      Property property_element_magnet =
          new Property(property_element.getName(), property_element.getOwner(), "magnet");
      Property property_element_supra =
          new Property(property_element.getName(), property_element.getOwner(), "supra");
      ...
      ITUtilProperties.assertRetrieveProperty(
          "/element?withChannels=true", property_element_channels);
      ITUtilProperties.assertRetrieveProperty("/element?withChannels=false", property_element);
      ...
      Property property_type_read =
          new Property(property_type.getName(), property_type.getOwner(), "read");
      Property property_type_write =
          new Property(property_type.getName(), property_type.getOwner(), "write");
      Property property_type_readwrite =
          new Property(property_type.getName(), property_type.getOwner(), "readwrite");
      ...
      Property property_cell_block1 =
          new Property(property_cell.getName(), property_cell.getOwner(), "block1");
      Property property_cell_block2 =
          new Property(property_cell.getName(), property_cell.getOwner(), "block2");
      Property property_cell_block3 =
          new Property(property_cell.getName(), property_cell.getOwner(), "block3");
      Property property_cell_block4 =
          new Property(property_cell.getName(), property_cell.getOwner(), "block4");
      Property property_cell_block5 =
          new Property(property_cell.getName(), property_cell.getOwner(), "block5");
