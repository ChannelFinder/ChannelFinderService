...
public class TextUtil {
  ...
  public static final String PAYLOAD_PROPERTY_DOES_NOT_MATCH_URI_OR_HAS_BAD_VALUE =
      "The payload property {0} does not match uri name or has a bad value";
  ...
  public static final String CHANNEL_NAME_DOES_NOT_EXIST =
      "The channel with the name {0} does not exist";
  public static final String CHANNEL_NAME_CANNOT_BE_NULL_OR_EMPTY =
      "The channel name cannot be null or empty {0}";
  public static final String CHANNEL_OWNER_CANNOT_BE_NULL_OR_EMPTY =
      "The channel owner cannot be null or empty {0}";
  public static final String CHANNEL_NAME_NO_VALID_INSTANCE_PROPERTY =
      "The channel with the name {0} does not include a valid instance to the property {1}";
  ...
  public static final String FIND_ALL_CHANNELS_NOT_SUPPORTED =
      "Find all is not supported. It could return hundreds of thousands of channels.";
  ...
  public static final String FAILED_TO_CHECK_IF_CHANNEL_EXISTS =
      "Failed to check if channel exists {0}";
  public static final String FAILED_TO_DELETE_CHANNEL = "Failed to delete channel {0}";

  public static final String USER_NOT_AUTHORIZED_ON_CHANNEL =
      "User does not have the proper authorization to perform an operation on this channel {0}";
  public static final String USER_NOT_AUTHORIZED_ON_CHANNELS =
      "User does not have the proper authorization to perform an operation on these channels {0}";
  ...
  public static final String PROPERTY_NAME_DOES_NOT_EXIST =
      "The property with the name {0} does not exist";
  public static final String PROPERTY_NAME_CANNOT_BE_NULL_OR_EMPTY =
      "The property name cannot be null or empty {0}";
  public static final String PROPERTY_OWNER_CANNOT_BE_NULL_OR_EMPTY =
      "The property owner cannot be null or empty {0}";
  public static final String PROPERTY_VALUE_NULL_OR_EMPTY =
  ...
  public static final String FAILED_TO_UPDATE_SAVE_PROPERTIES =
      "Failed to update/save properties {0}";
  ...
  public static final String FAILED_TO_CHECK_IF_PROPERTY_EXISTS =
      "Failed to check if property exists {0}";
  public static final String FAILED_TO_DELETE_PROPERTY = "Failed to delete property {0}";

  public static final String USER_NOT_AUTHORIZED_ON_PROPERTY =
      "User does not have the proper authorization to perform an operation on this property {0}";
  public static final String USER_NOT_AUTHORIZED_ON_PROPERTIES =
      "User does not have the proper authorization to perform an operation on these properties {0}";
  ...
  public static final String TAG_NAME_CANNOT_BE_NULL_OR_EMPTY =
      "The tag name cannot be null or empty {0}";
  public static final String TAG_OWNER_CANNOT_BE_NULL_OR_EMPTY =
      "The tag owner cannot be null or empty {0}";
  ...
  public static final String USER_NOT_AUTHORIZED_ON_TAG =
      "User does not have the proper authorization to perform an operation on this tag {0}";
  public static final String USER_NOT_AUTHORIZED_ON_TAGS =
      "User does not have the proper authorization to perform an operation on these tags {0}";
