...
/**
 * #%L ChannelFinder Directory Service %% Copyright (C) 2010 - 2012 Helmholtz-Zentrum Berlin für
 * Materialien und Energie GmbH %% Copyright (C) 2010 - 2012 Brookhaven National Laboratory All
 * rights reserved. Use is subject to license terms. #L%
 */
...
public class Channel {
  ...
  /**
   * Add the given tag to the list of tags associated with this channel If the tag already exists
   * then it is replaced with <code>tag</code>
   *
  ...
  /**
   * Add the given property to the list of properties associated with this channel If the property
   * already exists then it is replaced with the provided one
   *
   ...
   */
  public String toLog() {
    return this.getName() + "(" + this.getOwner() + "):[" + (this.properties) + (this.tags) + "]";
  }
