...
public class Property {
  ...
  /**
   * A filter to be used with the jackson mapper to ignore the embedded xmlchannels in the property
   * object
   *
   * @author Kunal Shroff
   */
  public abstract static class OnlyProperty {
    @JsonIgnore private List<Channel> channels;
  }

  /**
   * A filter to be used with the jackson mapper to ignore the embedded xmlchannels and value in the
   * property object
   *
   * @author Kunal Shroff
   */
